...
class LawyerCreateAdvisoryServiceReservationTask extends BaseTask
{

    public function run(LawyerCreateAdvisoryServiceReservationRequest $request)
    {
        ...
        if ($advisory->advisoryService->need_appointment == 1) {
            ...
            if ($this->isTimeSlotReserved($from, $to, $date)) {
    ...
    protected function isTimeSlotReserved($start, $end, $date)
    {
