...
import { ClientUser, OldClientUser } from "../../types/ClientUser";
...
const EditClient = ({
    ...
    const [name, setName] = useState(client.myname);
    const [phoneCode, setPhoneCode] = useState(client.phone_code);
    const [mobile, setMobile] = useState(
        client.mobil.replace(new RegExp(`${phoneCode}`), "")
    );
    ...
    const [selectedRegion, setSelectedRegion] = useState(client.region_id);
    const [selectedCity, setSelectedCity] = useState(client.city_id);
    const [gender, setGender] = useState(client.gender || "");
    const [status, setStatus] = useState(client.accepted.toString() || "");
