        ...
        <>
            <DeleteModal
                ...
                confirmAction={async () => {
                    try {
                        axios.delete(
                            `/newAdmin/settings/book-guide/main/${deleteModalOpen.id}`
                        );
                        ...
                        router.get("/newAdmin/settings/book-guide/main");
                    } catch (err) {
                        toast.error("حدث خطأ");
                    }
                }}
                confirmationText={
                    "عند حذف القسم الرئيسي, سيتم حذف كل الأنظمة المندرجة تحتها و موادها"
                }
            />
            <DefaultLayout>
