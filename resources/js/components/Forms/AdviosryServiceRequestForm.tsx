...
function AdvisoryServiceRequestForm({
    request,
    errors,
    saveData,
    advisories,
    ...
    useEffect(() => {
        console.log("assign", assignToAdvisory);
        console.log("assign", changeLawyer);
    }, [assignToAdvisory, changeLawyer]);
    return (
        <>
            <form
...
export default AdvisoryServiceRequestForm;
