...
function ReservationsSettings({
    ...
    return (
        <SidebarLinkGroup
            activeCondition={pathname.includes("settings/reservations")}
        >
            {(handleClick, open) => {
                return (
                    <React.Fragment>
                        <Link
                            ...
                            className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                                pathname.includes("settings/reservations") &&
                        ...
                        >
                            <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                                <li>
                                    <Link
                                        href="/newAdmin/settings/reservations/types"
                                        className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white
                                            ${
                                                pathname.includes(
                                                    "/newAdmin/settings/reservations/types"
                                                ) && "!text-white"
                                            }`}
                                    >
                                        انواع المواعيد{" "}
