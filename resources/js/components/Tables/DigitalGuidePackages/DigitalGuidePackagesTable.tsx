...
const DigitalGuidePackagesTable = ({
    headers,
    data,
    setDeleteModalOpen,
}: {
        ...
        >
            ...
            <div className="max-w-full overflow-x-auto">
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        {currentData.map((packageDetails, key) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`packages/${packageDetails.id}`}
...
export default DigitalGuidePackagesTable;
