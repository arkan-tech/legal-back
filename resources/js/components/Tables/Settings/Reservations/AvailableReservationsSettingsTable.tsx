...
const AvailableReservationsSettingsTable = ({
    headers,
    data,
}: {
    headers: string[];
        ...
        >
            <div className="grid grid-cols-12 gap-2">
                ...
                <div className="col-span-6 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/reservations/available-reservations/create"
...
export default AvailableReservationsSettingsTable;
