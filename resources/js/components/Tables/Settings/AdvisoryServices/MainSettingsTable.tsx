...
const MainSettingsTable = ({
    ...
    }, [currentPage, searchQuery, selectedPaymentCategory]);
    return (
        <div
            style={{ direction: "rtl" }}
        ...
        >
            <div className="grid grid-cols-12 gap-2">
                ...
                <div className="col-span-2 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/advisory-services/create"
            ...
            <div className="max-w-full overflow-x-auto">
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        {currentData.map((advisoryService, key) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {advisoryService.category}
                                    </h5>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {advisoryService.base}
                                    </h5>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {advisoryService.name}
                                    </h5>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {advisoryService.needAppointment}
                                    </h5>
                                </td>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/advisory-services/${advisoryService.id}`}
...
export default MainSettingsTable;
