...
const PaymentCategoriesSettingsTable = ({
    headers,
    data,
    base,
    setDeleteModalOpen,
    ...
    useEffect(() => {
        setFilteredData(
            data
                ...
                .filter(
                    (category) =>
                        category.type === selectedType || selectedType === ""
                )
        );
        setCurrentData(
            data
        ...
        >
            <div className="grid grid-cols-12 gap-2">
                ...
                <div className="col-span-2 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/advisory-services/payment-categories/create"
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/advisory-services/payment-categories/${category.id}`}
...
export default PaymentCategoriesSettingsTable;
