...
const AdvisoryServicesMainTableSettings = ({
    headers,
    data,
    setDeleteModalOpen,
    compact = false,
        ...
        >
            <div className="grid grid-cols-12 gap-2">
                ...
                <div className="col-span-6 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/advisory-services/general-categories/create"
                    ...
                    <tbody>
                        {currentData.map((base, key) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {base.payment_category_type.name}
                                    </h5>
                                </td>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/advisory-services/general-categories/${base.id}/edit`}
...
export default AdvisoryServicesMainTableSettings;
