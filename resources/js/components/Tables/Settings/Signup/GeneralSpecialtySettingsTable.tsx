...
const GeneralSpecialtySettingsTable = ({
    headers,
    data,
}: {
    headers: string[];
        ...
        >
            <div className="grid grid-cols-12 gap-2 mb-2">
                ...
                <div className="col-span-6 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/signup/general-specialty/create"
            ...
            <div className="max-w-full overflow-x-auto">
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        {currentData.map((generalSpecialty, key) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/signup/general-specialty/${generalSpecialty.id}`}
                                        ...
                                        <button
                                            onClick={() =>
                                                router.get(
                                                    `/admin/general-specialty/delete/${generalSpecialty.id}`,
                                                    {},
                                                    {
                                                        onSuccess: () => {
                                                            toast.success(
...
export default GeneralSpecialtySettingsTable;
