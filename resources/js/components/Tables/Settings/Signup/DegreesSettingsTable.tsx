        ...
        >
            <div className="grid grid-cols-12 gap-2 mb-2">
                ...
                <div className="col-span-6 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/signup/degrees/create"
                            ...
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/signup/degrees/${job.id}`}
                                        ...
                                        <button
                                            onClick={async () => {
                                                try {
                                                    const res =
                                                        await axios.delete(
                                                            `/newAdmin/settings/signup/degrees/${job.id}`
                                                        );
                                                    router.get(
...
export default DegreesSettingsTable;
