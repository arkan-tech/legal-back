...
const AccurateSpecialtySettingsTable = ({
    headers,
    data,
}: {
    headers: string[];
        ...
        >
            <div className="grid grid-cols-12 gap-2 mb-2">
                ...
                <div className="col-span-6 flex items-center justify-end">
                    <Link
                        href="/newAdmin/settings/signup/accurate-specialty/create"
            ...
            <div className="max-w-full overflow-x-auto">
                <table className="w-full table-auto">
                    ...
                    <tbody>
                        {currentData.map((accurateSpecialty, key) => (
                            <tr key={key}>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {accurateSpecialty.id}
                                    </h5>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {accurateSpecialty.name}
                                    </h5>
                                </td>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <div className="flex items-center gap-5">
                                        <Link
                                            href={`/newAdmin/settings/signup/accurate-specialty/${accurateSpecialty.id}`}
                                        ...
                                        <button
                                            onClick={() =>
                                                router.get(
                                                    `/admin/accurate-specialty/delete/${accurateSpecialty.id}`,
                                                    {},
                                                    {
                                                        onSuccess: () => {
                                                            toast.success(
...
export default AccurateSpecialtySettingsTable;
