...
import { Request } from "../../Pages/Advisory-Services-Requests/client";
import Pagination from "../Pagination";
import { ReservationRequestStatus } from "../ProductRequestStatus/ReservationRequestStatus";
const ReservatationRequestsTable = ({
    headers,
    data,
    reserverType = "client",
}: {
                    ...
                    <tbody>
                        {currentData.map((request, key) => (
                            <tr key={key}>
                                ...
                                <td className="border-b border-[#eee] py-5 px-4 pl-9 dark:border-strokedark xl:pl-11">
                                    <h5 className="font-medium text-black dark:text-white">
                                        {request.reservationImportance}
                                    </h5>
                                </td>
                                <td className="border-b border-[#eee] py-5 px-4 dark:border-strokedark">
                                    <p className="text-black dark:text-white">
                                        {request.reservationAttended}
                                    </p>
                                </td>
...
export default ReservatationRequestsTable;
