...
<head>
    ...
    <link rel="shortcut icon" href="{{asset('ite/images/logo.png')}}" type="image/x-icon" />
    ...
    <!--[if lt IE 9]><script src="{{asset('site/js/respond.js')}}"></script><![endif]-->
                ...
                <div class="sidebar-textwidget">
                    ...
                    <div class="sidebar-info-contents">
                        <div class="content-inner">
                            <div class="logo">
                                <a href="/">
                                    <img src="{{asset('site/images/logo.png')}}" alt="" /></a>
                            </div>
