    ...
    <section class="page-title" style="background-image: url('{{ asset('images/background/8.jpg') }}')">
        <div class="auto-container">
            ...
            <ul class="page-breadcrumb">
                ...
                <li><a href="/justice-guide">الدليل العدلى</a></li>
                <li>{{ $category->name }}</li>
            </ul>
            ...
            <div class="row clearfix">
                @foreach ($justice_guides as $justice_guide)
                    ...
                    <div class="team-block-two col-lg-3 col-md-6 col-sm-12">
                        <div class="inner-box">
                            <div class="image">
                                <a href="{{ route('site.justice.guide.viewbuilding', $justice_guide->id) }}"><img
                                        src=" {{ $justice_guide->image }} " alt="" /></a>
                                <div class="color-layer"></div>
                                <!-- Social Box -->
                                <ul class="social-box">
                                    <!-- <li> {{ $justice_guide->About }}</li> -->
                                </ul>
                            </div>
                            <div class="lower-content">
                                <h5><a href="/view-building/{{ $justice_guide->id }}">{{ $justice_guide->title }}</a></h5>
                            </div>
                        </div>
                    </div>
                @endforeach
        ...
        <div class="auto-container">
            <div class="inner-container">
                <div class="pattern-layer-one"
                    style="background-image:url('{{ asset('images/icons/cta-pattern-1.png') }}')"></div>
                <div class="pattern-layer-two"
                    style="background-image:url('{{ asset('images/icons/cta-pattern-2.png') }}')"></div>
                <div class="row clearfix">
                    <!-- Title Column -->
