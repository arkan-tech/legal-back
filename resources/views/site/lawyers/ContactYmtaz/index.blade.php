        ...
        <div class="auto-container">
            <div class="row clearfix">
                <div class="form-column column col-lg-12 col-md-12 col-sm-12">
                    <div class="sec-title">
                        <a style="padding: 15px 30px; float: left" class="theme-btn btn-style-three" href="{{route('site.lawyer.contact-ymtaz.create')}}">
                                ...
                                <table class="table table-inbox table-hover">
                                    ...
                                    @foreach($messages as $request)
                                        <tr>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel"> محتوى الرسالة </h4>
                                                            </div>
                                            ...
                                            @if ($request->reply != '') {
                                            <td>
                                                <div style="cursor: pointer; background: #dd9b25; text-align: center; color: #fff; padding: 8px 0px;" class="span4 proj-div" data-toggle="modal" data-target="#modal{{$request->id}}">
                                                    عرض رد يمتاز
                                                </div>
                                                <div id="modal{{$request->id}}" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="myModalLabel1"> {{ $request->ymtaz_reply_subject }} </h4>
                                                            </div>
