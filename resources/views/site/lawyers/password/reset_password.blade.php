                ...
                <div class="form-column column col-lg-9 col-md-12 col-sm-12">
                    ...
                    <div class="form-column column col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="styled-form register-form">
                            <form method="post" action="{{ route('site.lawyer.password.post-reset-password',$hash) }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-control" name="password" id="password" value="" placeholder="كلمة المرور الجديدة" required>
                                </div>
