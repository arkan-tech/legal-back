            ...
            <div class="row clearfix">
                ...
                <div class="form-column column col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="styled-form register-form">
                        <form method="post" id="save_client_delete_account_request" action="{{route('site.client.profile.delete-account.post')}}">
                            @csrf
                                ...
                                <div class="col-lg-4">
                                    <div class="clearfix text-center">
                                        <div style="width: 100%" class="form-group pull-left">
                                            <button id="save_client_delete_account_request_btn" type="submit"
...
@section('site_scripts')
    <script>
        $('#save_client_delete_account_request').on('submit', function (event) {
            ...
            $.ajax({
                ...
                processData: false,
                beforeSend: function () {
                    $("#save_client_delete_account_request_btn").attr('disabled','disabled');
                },
                success: function (response) {
                    $("#save_client_delete_account_request_btn").removeAttr('disabled',);
