...
@section('content')
                ...
                <section class="app-equipment-list">
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="contact_messages_list_table">
    ...
    <div class="modal fade text-start" id="show_message_modal" tabindex="-1" aria-labelledby="myModalLabel33"
         aria-hidden="true">
    ...
    <div class="modal fade text-start" id="replay_message_modal" tabindex="-1" aria-labelledby="myModalLabel33"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form id="replay_message_form" action="{{route('admin.contact.replay')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn btn-primary confirm_replay_message_btn" >ارسال الرد</button>
                    </div>
                </form>
            </div>
        </div>
...
@endsection
@section('scripts')
    <script src="{{asset('admin/app-assets/js/datatable/contact_messages/contact_messages_list.js?'.time())}}"></script>
