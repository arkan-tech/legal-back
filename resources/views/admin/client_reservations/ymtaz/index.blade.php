                ...
                <section class="app-equipment-list">
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="client_reservations_ymtaz_list_table">
...
@section('scripts')
    <script
        src="{{asset('admin/app-assets/js/datatable/client_reservations/ymtaz/client_reservations_ymtaz_list.js?'.time())}}"></script>
