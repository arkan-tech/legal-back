...
{{--                                    </a>--}}
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="client_reservations_list_table">
    ...
    <div class="modal fade text-start" id="show_client_reservations_modal" tabindex="-1"
...
@section('scripts')
    <script
        src="{{asset('admin/app-assets/js/datatable/client_reservations/client_reservations_list.js?'.time())}}"></script>
