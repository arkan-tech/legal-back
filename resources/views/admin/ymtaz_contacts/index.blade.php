...
@section('content')
                ...
                <section class="app-equipment-list">
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="ymtaz_messages_list_table">
    ...
    <div class="modal fade text-start" id="replay_ymtaz_message_modal" tabindex="-1" aria-labelledby="myModalLabel33"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <form id="replay_ymtaz_message_form" action="{{route('admin.ymtaz-contacts.replay')}}" method="post">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            ...
                            <a class="btn btn-primary download_ymtaz_file" >
                                تنزيل المرفقات
                            </a>
                        </div>
                    </div>
...
@endsection
@section('scripts')
    <script src="{{asset('admin/app-assets/js/datatable/ymtaz_contacts/ymtaz_contacts_list.js?'.time())}}"></script>
