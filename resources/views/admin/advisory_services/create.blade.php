                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="mt-2 pt-50 validate-form"
                              action="{{route('admin.advisory_services.store')}}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body mt-2">
                                    ...
                                    <div class="mb-1">
                                        <select name="payment_category_id" required class="form-control select2 @error('payment_category_id')is-invalid @enderror" id="payment_category_select">
									...
									<div class="mb-1" id="ymtaz_price_div">
                                        ...
                                        <input type="number"  name="ymtaz_price" class="form-control  @error('ymtaz_price')is-invalid @enderror" value="{{old('ymtaz_price')}}"/>
                                        @error('ymtaz_price')
                                        <p class="invalid-feedback">{{$message}}</p>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-1">
                                      ...
                                      class="form-control ck_editor @error('instructions')is-invalid @enderror">{!! old('instructions') !!}</textarea>
                                        @error('instructions')
                                        <p class="invalid-feedback">{{$message}}</p>
                                        @enderror
                                    </div>
											...
											<div data-repeater-item >
												<div class="row d-flex align-items-end">
													<div class=" col-md-5 col-12">
														<div class="mb-1">
															<label>المستوى</label>
															<select name="level_id" selected="{{$request_level->id}}" required
																	class="form-control select2">	
																	<option
																		value="{{ $request_level->id }}"> {{$request_level->title}}  
																	</option>
															</select>
														</div>
													</div>
