                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="mt-2 pt-50 validate-form"
                              action="{{route('admin.advisory_services.payment_categories.update')}}"
                                ...
                                <div class="card-body mt-2">
                                    ...
                                    <div class="mb-1">
                                        <select name="payment_method" class="form-control select2" id="payment_method">
                                            <option value="">-- اختر --</option>
                                            <option value="1" {{$item->payment_method == 1?'selected':''}}> مجانية</option>
                                            <option value="2" {{$item->payment_method == 2?'selected':''}}> مدفوعة</option>
                                            <option value="3" {{$item->payment_method == 3?'selected':''}}> متخصصة</option>
                                        </select>
                                        @error('title')
                                        <p class="invalid-feedback">{{$message}}</p>
                                        @enderror
                                    ...
                                    <div class="mb-1 {{$item->payment_method ==3 ?'':'d-none'}}" id="count_div">
                                    ...
                                    <div class="mb-1 {{$item->payment_method ==3 ?'':'d-none'}}" id="period_div">
