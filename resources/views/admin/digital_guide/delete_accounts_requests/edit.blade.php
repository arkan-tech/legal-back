                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="mt-2 pt-50 validate-form"
                              action="{{route('admin.digital-guide.delete-accounts.update')}}"
                                ...
                                <div class="card-body py-2 my-25">
                                    ...
                                    <div class="row mt-1">
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <span class="form-control">{{$request->lawyer->name}}</span>

                                        </div>

                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="form-label" for="accountFirstName"> البريد الالكتروني </label>
                                            <span class="form-control">{{$request->lawyer->email}}</span>
                                        </div>
                                    ...
                                    <div class="row ">
                                        <div class="col-12 col-sm-12 mb-1">
                                            ...
                                            <select
                                                ...
                                                <option {{$request->lawyer->type =='1' ?'selected' :''}}  value="1">
                                                    فرد
                                                </option>
                                                <option {{$request->lawyer->type =='2' ?'selected' :''}}  value="2">
                                                    مؤسسة
                                                </option>
                                                <option {{$request->lawyer->type =='3' ?'selected' :''}}  value="3">
                                                    شركة
                                                </option>
                                                <option {{$request->lawyer->type =='4' ?'selected' :''}} value="4">جهة
                                                    حكومية
                                                </option>
                                                <option {{$request->lawyer->type =='5' ?'selected' :''}}  value="5">
                                                    هيئة
                                                </option>
                                            </select>
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{route('admin.digital-guide.delete-accounts.index')}}" class="btn btn-outline-secondary mt-1">الرجوع للاصل
                                </a>
                            </div>
