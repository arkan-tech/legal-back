...
<script>
    ...
    $(document).ready(function () {
        ...
        if (lawyer_type == 1) {
            $('#company_lisences_no_div').css('display', 'none');
            $('#company_lisences_file_div').css('display', 'none');
            $('#company_name_div').css('display', 'none');
            $('#cv_div').css('display', 'block');
        } else if (lawyer_type == 2 || lawyer_type == 3) {
            $('#company_lisences_no_div').css('display', 'block');
            $('#company_lisences_file_div').css('display', 'block');
            $('#company_name_div').css('display', 'none');
	...
	$('#account-reset-img').on('click', function(){
		$('#account-upload-img').attr('src', '/uploads/person.png');
		$('#account-upload-img-btn').val('')
	})
	$('#account-reset-logo-btn').on('click', function(){
		$('#account-upload-logo').attr('src', '/uploads/person.png');
		$('#account-upload-logo-btn').val('')
	})
