                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="mt-2 pt-50 validate-form"
                              action="{{route('admin.digital-guide.packages.update')}}"
                              method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="id" value="{{$package->id}}">
                            <div class="card">
                                <div class="card-header border-bottom">
                                    <h4 class="card-title"> تعديل معلومات الباقة</h4>
                                </div>
                                    ...
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-6 col-sm-6 mb-1">
                                            ...
                                            <input type="number" class="form-control @error('period')is-invalid @enderror"
                                                   name="period" value="{{$package->period}}" />
                                            @error('period')
                                            <p class="invalid-feedback">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="col-12 col-sm-12 mb-1">
                                            ...
                                            <textarea type="text" class="form-control  @error('intro')is-invalid @enderror"
                                                      name="intro" rows="5" id="editor">{!! $package->intro !!}</textarea>
                                            @error('intro')
                                            <p class="invalid-feedback">{{$message}}</p>
                                            @enderror
                                        </div>
                                        <div class="col-12 col-sm-12 mb-1">
                                            ...
                                            <textarea type="text" class="form-control  @error('rules')is-invalid @enderror"
                                                      name="rules" rows="5" id="editor_rules">{!! $package->rules !!}</textarea>
                                            @error('rules')
                                            <p class="invalid-feedback">{{$message}}</p>
                                            @enderror
                                        </div>
