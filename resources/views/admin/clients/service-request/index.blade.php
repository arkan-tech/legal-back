...
@section('content')
                ...
                <section class="app-equipment-list">
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="service_request_list_table">
    ...
    <div class="modal fade text-start" id="show_client_service_request_modal" tabindex="-1"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            <a target="_blank" class="btn btn-primary download_service_request_file_show">
                                مرفقات العميل
                            </a>
                        </div>
                    ...
                    <hr>
                    <div id="admin_replay_status_div" class="row d-none">
                        <div class="col-lg-12">
                            <label> الرد على الاستشارة : </label>
                            <div class="mb-1">
                                <textarea id="replay" rows="5" class="form-control" disabled></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row d-none " id="comment">
                        <div class="col-lg-12">
                            <label> التعليق : </label>
                            <div class="mb-1">
                                <textarea id="comment_content"  rows="5" class="form-control" disabled ></textarea>
                            </div>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    ...
                    <a target="_blank" class="btn btn-primary download_service_request_replay_file d-none">
                        مرفقات الرد
                    </a>
                </div>
...
@section('scripts')
    <script
        src="{{asset('admin/app-assets/js/datatable/clients/service-request/service_request_list.js?'.time())}}"></script>
