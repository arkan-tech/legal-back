                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <form class="mt-2 pt-50 validate-form"
                              action="{{route('admin.library.judicial_blogs.update')}}"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body py-2 my-25">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-6 mb-1">
                                            ...
                                            <select id="sub_category_id"
                                                ...
                                                @include('admin.library.judicial_blogs.includes.sub-cat-select')
                                            </select>
                                    ...
                                    <div class="row release_tools">
                                        ...
                                        <table class="table text-center " id="JudicialBlogsReleaseToolsTable">
                                            <thead>
                                            <tr>
                                            ...
                                            @foreach($item->ReleasTools as $tool)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a class="btn-delete-judicial-blogs-release-tools m-1"
                                                           id="btn_delete_judicial_blogs_release_tools_{{$tool->id}}"
                                                           href="{{route('admin.library.judicial_blogs.delete.release.tool', $tool->id)}}"
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{route('admin.library.judicial_blogs.index')}}" type="reset"
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.btn-delete-judicial-blogs-release-tools', function (e) {
            e.preventDefault();
            ...
            Swal.fire({
                ...
                customClass: {
                    confirmButton: "btn btn-primary confirm_btn_judicial_blogs_release_tools",
                    cancelButton: "btn btn-outline-danger ms-1"
                },
                buttonsStyling: !1
            });
            $('.confirm_btn_judicial_blogs_release_tools').on('click', function (t) {
                t.preventDefault();
                $.ajax({
                    url: actionUrl,
                    type: 'get',
                    success: function (response) {
                        $('#JudicialBlogsReleaseToolsTable #btn_delete_judicial_blogs_release_tools_' + pid).closest('tr').css('background', '#714f4f').delay(500).hide(500);
                        setTimeout(() => {
                            Swal.fire({
                                icon: "success",
                                title: "تم الحذف !",
