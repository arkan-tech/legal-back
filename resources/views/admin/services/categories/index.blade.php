...
@section('content')
                ...
                <section class="app-equipment-list">
                    <div class="card">
                        ...
                        <div class="card-datatable table-responsive pt-0">
                            <table class="table text-center" id="services_categories_list_table">
    ...
    <div class="modal fade text-start" id="edit_services_categories_modal" tabindex="-1" aria-labelledby="myModalLabel33"
         aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <form action="{{route('admin.services.categories.update')}}" method="post" id="edit_services_categories_form">
                    @csrf
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-1">
                            <input type="text" id="name" name="name" class="form-control"/>
                            <span style="display: block;text-align: right;"
                                  class="text-danger error-text services_categories_update_name_error"></span>
                        </div>
...
@endsection
@section('scripts')
    <script src="{{asset('admin/app-assets/js/datatable/services/categories/services_categories_list.js?'.time())}}"></script>
@endsection
