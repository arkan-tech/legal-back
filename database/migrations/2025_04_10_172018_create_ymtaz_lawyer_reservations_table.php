...
return new class extends Migration
{
    ...
    {
                if (!Schema::hasTable('ymtaz_lawyer_reservations')) {
Schema::create('ymtaz_lawyer_reservations', function (Blueprint $table) {
...
3-> ملغي');
    ...
    {
        Schema::dropIfExists('ymtaz_lawyer_reservations');
    }
};